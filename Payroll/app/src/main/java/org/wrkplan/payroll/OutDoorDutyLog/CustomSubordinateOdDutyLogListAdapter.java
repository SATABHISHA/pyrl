...
public class CustomSubordinateOdDutyLogListAdapter extends RecyclerView.Adapter<CustomSubordinateOdDutyLogListAdapter.MyViewHolder> {
...
//    public static TextView tv_download;
    ...
    public CustomSubordinateOdDutyLogListAdapter(Context ctx, ArrayList<OutDoorLogListModel> outDoorLogListModelArrayList){

        inflater = LayoutInflater.from(ctx);
        this.outDoorLogListModelArrayList = outDoorLogListModelArrayList;
    }
    @Override
    public CustomSubordinateOdDutyLogListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.custom_subordinate_od_duty_log_list_row, parent, false);
        CustomSubordinateOdDutyLogListAdapter.MyViewHolder holder = new CustomSubordinateOdDutyLogListAdapter.MyViewHolder(view);
        context = parent.getContext();
        return holder;
    }

    @Override
    public void onBindViewHolder(CustomSubordinateOdDutyLogListAdapter.MyViewHolder holder, int position) {
...
//        TextView btn_view_time_log, btn_view_task;
...
//                    DateFormat inputFormat = new SimpleDateFormat("dd/MM/yyyy");
                    ...
                    OdDutyLogListActivity.log_task_status = 1;

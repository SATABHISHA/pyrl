...
public class PdfEditorActivityDashboard extends AppCompatActivity implements View.OnClickListener {
                    ...
                    public void onSuccess(File file) {
                       ...
                       /* Uri pdfUri = Uri.fromFile(savedPDFFile);
                        ...
                        if (fileToPrint == null || !fileToPrint.exists()) {
                            Toast.makeText(PdfEditorActivityDashboard.this, "Generated File is null or does not exist!", Toast.LENGTH_SHORT).show();
//                            return super.onOptionsItemSelected(item);
                        ...
                        PDFUtil.printPdf(PdfEditorActivityDashboard.this, fileToPrint, printAttributeBuilder.build());
                    }
...
//        webView.loadData(HtmlStringDemo.html_hardcoded_string_demo,"text/html",null);
        webView.loadDataWithBaseURL(null, DashboardActivity.report_html, "text/html", "utf-8", null);

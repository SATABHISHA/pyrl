package org.wrkplan.payroll.service;
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        NotificationCompat.Builder builder =
                new NotificationCompat.Builder(
                        ...
                        .setAutoCancel(true)
                        .setLargeIcon(((BitmapDrawable)getDrawable(R.drawable.wrkplan_payroll_logo)).getBitmap())
                        .setSmallIcon(R.drawable.wrkplan_payroll_logo)
